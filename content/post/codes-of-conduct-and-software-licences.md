...
This all may seem like lunacy, but in practice, it works out pretty well now that we all know and agree on the rules. Tools like github and `npm init` prompt projects to choose a licence before they even make their first commit. Junior developer occasionally create projects without licences, but this is almost always noticed and fixed before it becomes a problem.
